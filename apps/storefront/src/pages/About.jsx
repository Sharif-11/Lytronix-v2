...
const VALUES = [
  {
    icon: ShieldCheck,
    title: '১০০% আসল পণ্য',
    body: 'আমাদের তালিকাভুক্ত প্রতিটি পাওয়ার ব্যাংক, চার্জার ও ব্যাটারি সংগ্রহ করা হয় আসল হিসেবে — কোনো নকল পণ্য নেই।',
  },
  {
    icon: Truck,
  ...
  },
  {
    ...
    body: 'ক্যাশ অন ডেলিভারি অথবা বিকাশ — যেটি সহজ মনে করেন সেটি বেছে নিন, পাঠানোর আগে আমরা নিশ্চিত করি।',
  },
  {
    icon: HeartHandshake,
    title: 'প্রকৃত সহায়তা',
    body: 'অর্ডার বা পণ্য নিয়ে কোনো প্রশ্ন থাকলে ফোন, হোয়াটসঅ্যাপ অথবা যোগাযোগ ফর্মে জানান — একজন মানুষই উত্তর দেবে।',
  },
];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-4 text-ui-muted text-sm sm:text-base leading-relaxed">
          ...
          চার্জার কেনা মানেই যেন আসল পণ্য পাওয়া নিয়ে অনিশ্চয়তা বা ডেলিভারি নিয়ে দুশ্চিন্তা না হয়। আমরা
          বেছে বেছে পণ্যের তালিকা তৈরি করি, নিজেরাই সম্পূর্ণ ডেলিভারি প্রক্রিয়া পরিচালনা করি, এবং যা
      ...
      <div className="card p-8 text-center bg-gradient-to-b from-ui-brand/[0.06] to-transparent">
        ...
        <p className="text-sm text-ui-muted mb-5 max-w-md mx-auto">
          সঠিক পণ্য বেছে নিতে অথবা আগের কোনো অর্ডারের খোঁজ নিতে আমরা সাহায্য করতে পেরে খুশি হব।
        </p>
