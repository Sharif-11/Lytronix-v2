...
const VALUES = [
  {
    icon: ShieldCheck,
    title: '১০০% অরিজিনাল সেল',
    body: 'তালিকাভুক্ত প্রতিটি লিথিয়াম ব্যাটারি সেল, অ্যাসেম্বলড প্যাক ও BMS যাচাই করে অরিজিনাল হিসেবে সংগ্রহ করা হয় — কোনো নকল বা রিসাইকেল সেল নয়।',
  },
  {
    icon: Truck,
  ...
  {
    icon: HeartHandshake,
    title: 'ইনস্ট্যান্ট সাপোর্ট',
    body: 'অর্ডার বা প্রোডাক্ট নিয়ে কোনো প্রশ্ন থাকলে ফোন, হোয়াটসঅ্যাপ বা কন্টাক্ট ফর্মে মেসেজ দিন — আমরা দ্রুত রিপ্লাই দিব।',
  },
];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-4 text-ui-muted text-sm sm:text-base leading-relaxed">
          {COMPANY_NAME}-এর যাত্রা শুরু হয়েছিল একটি সহজ ভাবনা থেকে: আইপিএস, ইউপিএস ও পাওয়ার ব্যাকআপের
          জন্য অনলাইনে লিথিয়াম ব্যাটারি সেল, অ্যাসেম্বলড প্যাক বা BMS কেনা মানেই যেন অরিজিনাল প্রোডাক্ট পাওয়া
          নিয়ে অনিশ্চয়তা বা ডেলিভারি নিয়ে দুশ্চিন্তা না হয়। আমরা বেছে বেছে প্রোডাক্টের তালিকা তৈরি করি,
          নিজেরাই সম্পূর্ণ ডেলিভারি প্রক্রিয়া পরিচালনা করি, এবং যা বিক্রি করি তার দায়িত্ব নিই।
        </p>
      </div>
