...
import {
  ...
  ShieldCheck, LogOut, Wallet, Landmark, Smartphone, Megaphone, Inbox, MessagesSquare,
} from 'lucide-react';
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/sms-listener', end: false, labelKey: 'nav.smsListener', icon: Smartphone, permission: 'payments:manage' },
