...
/*
    Vendored from the "avro-phonetic" npm package (jsAvroPhonetic), a
    dependency-free JS implementation of the Avro Phonetic Bangla
    transliteration scheme by OmicronLab. MPL-1.1 licensed — see
    AVRO-PHONETIC-LICENSE.txt in this folder. No jQuery / no network
    calls; runs entirely client-side.

    Original file: dist/avro-lib-v1.1.4.js
